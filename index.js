...
(function() {
 ...
 loadPackage({
  "files": [ {
   "filename": "/shaders/grid.frag",
   "start": 0,
   "end": 1377,
   "audio": 0
  }, {
   "filename": "/shaders/post.frag",
   "start": 1377,
   "end": 2718,
   "audio": 0
  }, {
   "filename": "/shaders/tiles.frag",
   "start": 2718,
   "end": 3247,
   "audio": 0
  }, {
   "filename": "/shaders/post.vert",
   "start": 3247,
   "end": 3327,
   "audio": 0
  }, {
   "filename": "/shaders/texture.frag",
   "start": 3327,
   "end": 4925,
   "audio": 0
  }, {
   "filename": "/shaders/texture.vert",
   "start": 4925,
   "end": 5005,
   "audio": 0
  }, {
   "filename": "/shaders/grid.vert",
   "start": 5005,
   "end": 5085,
   "audio": 0
  }, {
   "filename": "/shaders/tiles.vert",
   "start": 5085,
   "end": 5165,
   "audio": 0
  }, {
   "filename": "/shaders/post2.frag",
   "start": 5165,
   "end": 7813,
   "audio": 0
  } ],
  "remote_package_size": 7813,
  "package_uuid": "12fe3293-e2ed-45d5-9ae0-a13224b1f7d5"
 });
})();
...
function _emscripten_glGetProgramiv(program, pname, p) {
 ...
 if (pname == 35716) {
  ...
  _asan_js_store_4(p >> 2, ptable.maxUniformLength);
 } else if (pname == 35722) {
  ...
  _asan_js_store_4(p >> 2, ptable.maxAttributeLength);
 } else if (pname == 35381) {
  ...
  _asan_js_store_4(p >> 2, ptable.maxUniformBlockNameLength);
 } else {
  _asan_js_store_4(p >> 2, GLctx.getProgramParameter(GL.programs[program], pname));
 }
}
...
function registerKeyEventCallback(target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) {
 ...
 var keyEventHandlerFunc = function(e) {
  ...
  _asan_js_store_4(idx + 0, e.location);
  _asan_js_store_4(idx + 1, e.ctrlKey);
  _asan_js_store_4(idx + 2, e.shiftKey);
  _asan_js_store_4(idx + 3, e.altKey);
  _asan_js_store_4(idx + 4, e.metaKey);
  _asan_js_store_4(idx + 5, e.repeat);
  _asan_js_store_4(idx + 6, e.charCode);
  _asan_js_store_4(idx + 7, e.keyCode);
  _asan_js_store_4(idx + 8, e.which);
...
function fillMouseEventData(eventStruct, e, target) {
 ...
 _asan_js_store_4(idx + 0, e.screenX);
 _asan_js_store_4(idx + 1, e.screenY);
 _asan_js_store_4(idx + 2, e.clientX);
 _asan_js_store_4(idx + 3, e.clientY);
 _asan_js_store_4(idx + 4, e.ctrlKey);
 _asan_js_store_4(idx + 5, e.shiftKey);
 _asan_js_store_4(idx + 6, e.altKey);
 _asan_js_store_4(idx + 7, e.metaKey);
 _asan_js_store_2(idx * 2 + 16, e.button);
 _asan_js_store_2(idx * 2 + 17, e.buttons);
 _asan_js_store_4(idx + 9, e["movementX"]);
 _asan_js_store_4(idx + 10, e["movementY"]);
 var rect = getBoundingClientRect(target);
 _asan_js_store_4(idx + 11, e.clientX - rect.left);
 _asan_js_store_4(idx + 12, e.clientY - rect.top);
}
...
function registerTouchEventCallback(target, userData, useCapture, callbackfunc, eventTypeId, eventTypeString, targetThread) {
 ...
 var touchEventHandlerFunc = function(e) {
  ...
  _asan_js_store_4(touchEvent >> 2, numTouches);
...
var _setFade = Module["_setFade"] = createExportWrapper("setFade");

var _changePause = Module["_changePause"] = createExportWrapper("changePause");

var _setSpeed = Module["_setSpeed"] = createExportWrapper("setSpeed");

var _reverseA = Module["_reverseA"] = createExportWrapper("reverseA");

var _nextFrame = Module["_nextFrame"] = createExportWrapper("nextFrame");
...
var ___heap_base = Module["___heap_base"] = 278400304;
...
if (!Object.getOwnPropertyDescriptor(Module, "WasmOffsetConverter")) Module["WasmOffsetConverter"] = function() {
 abort("'WasmOffsetConverter' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
};

if (!Object.getOwnPropertyDescriptor(Module, "WasmSourceMap")) Module["WasmSourceMap"] = function() {
 abort("'WasmSourceMap' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)");
};
