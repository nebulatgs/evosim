...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']("/", "shaders", true, true);
   ...
   loadPackage({"files": [{"filename": "/shaders/grid.frag", "start": 0, "end": 1377, "audio": 0}, {"filename": "/shaders/tiles.frag", "start": 1377, "end": 1906, "audio": 0}, {"filename": "/shaders/texture.frag", "start": 1906, "end": 3504, "audio": 0}, {"filename": "/shaders/texture.vert", "start": 3504, "end": 3584, "audio": 0}, {"filename": "/shaders/grid.vert", "start": 3584, "end": 3664, "audio": 0}, {"filename": "/shaders/tiles.vert", "start": 3664, "end": 3744, "audio": 0}], "remote_package_size": 3744, "package_uuid": "e1d1e60e-305d-4d49-8a4d-8f8eaa6b6bb8"});
...
var ASM_CONSTS = {
  63960: function() {var width = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth; return width;},  
 64078: function() {var height = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight; return height;},  
 ...
 66645: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 66738: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 66807: function() {return screen.width;},  
 66832: function() {return screen.height;},  
 66858: function() {return window.innerWidth;},  
 66888: function() {return window.innerHeight;},  
 66919: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 67014: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 67151: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 67375: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { autoResumeAudioContext(SDL2.audioContext); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 67868: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
...
/** @type {function(...*):?} */
var _setFade = Module["_setFade"] = function() {
  return (_setFade = Module["_setFade"] = Module["asm"]["setFade"]).apply(null, arguments);
};
